...
const CertificateCard = ({ title, description, place, date, imgsrc, link }) => {
  return (
    <div className="col-span-full sm:col-span-3 lg:col-span-4 group bg-gradient-blue rounded-xl p-6 border border-outline-variant/10 transition-all duration-300 hover:scale-105 brightness-85 timeline-view animate-range-early-entry animate-fade-in-right overflow-hidden">
